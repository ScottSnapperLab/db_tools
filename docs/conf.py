...
# -*- coding: utf-8 -*-
#
# db_tools documentation build configuration file, created by
...
def run_apidoc(_):
    ...
    module_path = cur_dir.parent / "db_tools"
...
version = db_tools.__version__
# The full version, including alpha/beta/rc tags.
release = db_tools.__version__
...
latex_documents = [
    ('index', 'db_tools.tex',
     u'Database Tools Documentation',
     u'Gus Dunn', 'manual'),
]
